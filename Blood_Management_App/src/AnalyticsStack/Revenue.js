    ...
    const submitMonthlyBreakout = () => {
        if (breakoutYear == '' || breakoutYear == '0') {
            ...
            if (breakoutMonth == '' || breakoutMonth == "00") {
                ...
                dispatch(getMonthlyBreakout(breakoutYear, breakoutMonth, authState.userToken))
        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <View
                    ...
                    <View style={{ borderBottomWidth: 2, borderBottomColor: colors.primary, width: 130 }}>
                        <Picker
                            style={{ borderColor: colors.primary, borderWidth: 2, width: 130, height: 20 }}
                            enabled={true}
                ...
                <View style={{ left: 5, right: 10, height: 200, width: Dimensions.get("screen").width - 30, flexDirection: 'row' }}>
                    {salesState &&
                        salesState.currentMonthData &&
                        <YAxis
                    ...
                    <View style={{ flexDirection: 'column', flex: 1 }}>
                        <BarChart style={{ flex: 1, left: 0, right: 0 }} data={salesState.currentMonthData} svg={{ fill }} contentInset={{ top: 20, bottom: 9, right: 5, left: 5 }}>
                            <Grid />
                        </BarChart>
                        <XAxis
                ...
                <View>
                    ...
                    <View style={{ flexDirection: 'row', }}>
                        ...
                        <View style={{ borderBottomWidth: 2, borderBottomColor: colors.primary, width: 130, marginHorizontal: 20 }}>
                            <Picker
                                style={{ borderColor: colors.primary, borderWidth: 2, width: 130, height: 20, paddingBottom: 30 }}
                                enabled={true}
                        ...
                        <TouchableOpacity onPress={() => submitMonthlyBreakout()} style={styles.button}>
                            <Text style={styles.button_text}>Go</Text>
                        </TouchableOpacity>
                    </View>
                    {salesState &&
                        salesState.breakoutData &&
                        <View style={{ left: 5, right: 10, height: 200, width: Dimensions.get("screen").width - 30, flexDirection: 'row' }}>
                            ...
                            />
                            <View style={{ flexDirection: 'column', flex: 1 }}>
                                <BarChart style={{ flex: 1 }} data={salesState.breakoutData} svg={{ fill }} contentInset={{ top: 20, bottom: 10, right: 10, left: 10 }}>
                                    <Grid />
                                </BarChart>
                                <XAxis
                                    style={{ marginHorizontal: 0 }}
