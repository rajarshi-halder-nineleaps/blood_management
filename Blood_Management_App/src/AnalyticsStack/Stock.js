...
const Stock = ({ navigation }) => {
    ...
    useEffect(() => {
        dispatch(getStockInfo(authState.userToken, breakoutYear, breakoutMonth, type));
    }, [dispatch]);
    ...
    const colorOfArray = ["#35FA87", "#A6A565", "#6D15EA", "#B8004A", "#353566", "#E23515", "#B5C722", "#695560"]
    const pieData = salesState.stockinfo
        ...
        .map((value, index) => ({
            ...
            svg: {
                fill: randomColor(),
                onPress: () =>
                    Alert.alert('Details', value.toFixed(0) + " Units of " + bloodGroups[index], [
                        { text: 'Okay' },
                    ])
        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                ...
                <View
                    ...
                    <TouchableOpacity onPress={() => submitGetInfo()} style={styles.button}>
...
const styles = StyleSheet.create({
    ...
    pickerView: { borderBottomWidth: 2, borderBottomColor: colors.primary, width: 150, marginHorizontal: 20 },
    button: {
