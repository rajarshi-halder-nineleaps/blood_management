  ...
  return (
    <ScrollView>
      ...
      {salesState.monthSearched ? (
        <>
          <Text style={[styles.cardheader, {marginHorizontal: 10}]}>
          ...
          <Text style={styles.pietitle}>
            Total Blood:
            {type === 0 ? ' ₹ ' : null}
            {salesState.searchedMonthRevenue.totalBlood}{' '}
          </Text>
          <PieChart style={{height: 130}} data={pieDataplasma} />
          <Text style={styles.pietitle}>
            Total Plasma: {salesState.searchedMonthRevenue.totalPlasma}{' '}
          </Text>
          <PieChart style={{height: 130}} data={pieDataplatelet} />
          <Text style={styles.pietitle}>
            Total Platelets: {salesState.searchedMonthRevenue.totalPlatelet}{' '}
          </Text>
        </>
      ) : null}
    </ScrollView>
