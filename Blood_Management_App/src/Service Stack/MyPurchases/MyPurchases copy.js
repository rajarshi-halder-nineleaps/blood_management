...
import {getmypurchasesList} from '../../../redux/mypurchases/actions';
...
const MyPurchases = ({navigation}) => {
  ...
  const mypurchasesFormState = useSelector(
    (state) => state.mypurchasesFormState,
  );
  ...
  const renderItem = ({item}) => {
    ...
    return <Item item={item} style={{backgroundColor}} />;
  };
