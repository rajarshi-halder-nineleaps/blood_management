...
const regReducer = (state, action) =>{
    switch(action.type){
        case UPDATE_FIELDS_REG:{  
                ...
                const newInputValidity = {...state.inputValidity, phone: phoneIsValidArray};
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  const phoneNumberAdder = () =>{
      ...
      setItems((prevState) =>[...prevState, <Input
          ...
          onBlur = {() =>{blurListener("phone" + phoneCount + "")}}
        ...
        Alert.alert("Maximum limit reached", "You have reached the maximum limit of phone numbers", [{text: "Okay"}])
      }
  };
    ...
    <View style={styles.header}>
      ...
      <View style={styles.board}>
        ...
        <View style = {styles.addPhoneView}>
          <TouchableOpacity style = {styles.addPhoneTouch} onPress ={() =>phoneNumberAdder()}>
            <Feather
                  name= "plus"
                  color= 'white'
                  size= {20}
