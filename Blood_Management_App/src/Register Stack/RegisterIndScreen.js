...
const regReducer = (state, action) =>{
    switch(action.type){
        case UPDATE_FIELDS_REG:{  
                ...
                return {...state, inputValues: newInputValue, inputValidity: newInputValidity, finalFormState: newFinalFormState};
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const checkValidity = (val, fieldId) =>{
      console.log(fieldId)
        ...
        formDispatch({type: UPDATE_FIELDS_REG, val: val, fieldId: fieldId, isValid: isValid});
    };
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const sumbitHandler = () =>{
      ...
      if(regFormState.finalFormState){
        ...
        Alert.alert("Invalid Input", "Please check all the inputs before proceeding.", [{text: "Okay"}]);
    ...
    <View style={styles.header}>
      ...
      <View style={styles.board}>
        ...
        />
          ...
          {!regFormState.inputValidity.bloodgroup && regFormState.isTouched.bloodgroup && <Text style = {styles.errorMsg}>Please select your blood group</Text>}
        ...
        />
          ...
          {!regFormState.inputValidity.selectedState && regFormState.isTouched.selectedState && <Text style={styles.errorMsg}>Please select your state</Text>}
          ...
          {!regFormState.inputValidity.selectedDistrict && regFormState.isTouched.selectedDistrict && <Text style={styles.errorMsg}>Please select your district</Text>}
        ...
        <View>
          ...
          {!regFormState.inputValidity.tnc && regFormState.isTouched.tnc &&<Text>Please accept our terms and conditions.</Text>}
        </View>
